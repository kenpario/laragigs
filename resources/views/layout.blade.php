...
<body class="mb-48 dark:bg-gray-700">
    <nav class="flex justify-between items-center m-4 dark:bg-gray-800 bg-gray-200 rounded-lg dark:text-white">
    ...
    <footer class="bg-gray-200 rounded-lg shadow-sm m-2 dark:bg-gray-800 fixed bottom-0 left-0 right-0 opacity-75">
        <div class="flex w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
            ...
            <ul class="flex flex-wrap items-center text-sm font-medium text-white sm:mt-0">
                <li>
                    <a href="#" class="m-4 md:me-6 bg-red-500 hover:bg-red-600 p-2 rounded-lg">Post
                        Job</a>
                </li>
            </ul>
        </div>
